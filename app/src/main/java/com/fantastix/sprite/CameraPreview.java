...
//        FitToParent,
//        //Scale to the size that no side islarger than the parentNoBlank
//        // Scale to the size that no side is smaller than the parent
//    }
//
...
//        // called again due to the change of the layoutsize in this if-statement.
//
...
//        int reqPreviewWidth;
//        // requested width in terms of camera hardware
//        int reqPreviewHeight;
//        // requested height in terms of camera hardware
//        if (portrait) {
...
//
////                surfaceChanged = invocation.layoutChanged = true;
//            } else {
//                layoutChanged = false;
//            }
